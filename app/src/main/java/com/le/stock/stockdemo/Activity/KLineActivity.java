...
public class KLineActivity extends Activity {
    ...
    CombinedChart combinedchart,bottemcombinedchart;
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            bottemcombinedchart.setAutoScaleMinMaxEnabled(true);
            combinedchart.setAutoScaleMinMaxEnabled(true);

            combinedchart.notifyDataSetChanged();
            bottemcombinedchart.notifyDataSetChanged();

            combinedchart.invalidate();
            bottemcombinedchart.invalidate();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_kline);
        initChart();
        getOffLineData();
    }
    ...
    private void initChart() {
        bottemcombinedchart.setDrawBorders(true);
        bottemcombinedchart.setBorderWidth(1);
        bottemcombinedchart.setBorderColor(getResources().getColor(R.color.minute_grayLine));
        bottemcombinedchart.setDescription("");
        bottemcombinedchart.setDragEnabled(true);
        bottemcombinedchart.setScaleYEnabled(false);

        Legend barChartLegend = bottemcombinedchart.getLegend();
        barChartLegend.setEnabled(false);

        //BarYAxisFormatter  barYAxisFormatter=new BarYAxisFormatter();
        //bar x y轴
        xAxisBar = bottemcombinedchart.getXAxis();
        ...
        axisLeftBar = bottemcombinedchart.getAxisLeft();
        ...
        axisRightBar = bottemcombinedchart.getAxisRight();
...
//        xAxisK.setAvoidFirstLastClipping(true);
        ...
        bottemcombinedchart.setDragDecelerationEnabled(true);
        combinedchart.setDragDecelerationFrictionCoef(0.2f);
        bottemcombinedchart.setDragDecelerationFrictionCoef(0.2f);


        // 将K线控的滑动事件传递给交易量控件
        combinedchart.setOnChartGestureListener(new CoupleChartGestureListener(combinedchart, new Chart[]{bottemcombinedchart}));
        // 将交易量控件的滑动事件传递给K线控件
        bottemcombinedchart.setOnChartGestureListener(new CoupleChartGestureListener(bottemcombinedchart, new Chart[]{combinedchart}));

        bottemcombinedchart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            @Override
        ...
        combinedchart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, int dataSetIndex, Highlight h) {
                ...
                bottemcombinedchart.highlightValues(new Highlight[]{h});
            }

            @Override
            public void onNothingSelected() {
                bottemcombinedchart.highlightValue(null);
            }
        });
    ...
    private void setData(DataParse mData) {
        ...
        bottemcombinedchart.setData(bottemCombinedData);

        final ViewPortHandler viewPortHandlerBar = bottemcombinedchart.getViewPortHandler();
        ...
        combinedchart.moveViewToX(mData.getKLineDatas().size() - 1);
        bottemcombinedchart.moveViewToX(mData.getKLineDatas().size() - 1);
        setOffset();
 ...
 ****************************************************************************************/
    ...
    private void setOffset() {
        ...
        float barLeft = bottemcombinedchart.getViewPortHandler().offsetLeft();
        float lineRight = combinedchart.getViewPortHandler().offsetRight();
        float barRight = bottemcombinedchart.getViewPortHandler().offsetRight();
        float barBottom = bottemcombinedchart.getViewPortHandler().offsetBottom();
 ...
 /*注：setExtraLeft...函数是针对图表相对位置计算，比如A表offLeftA=20dp,B表offLeftB=30dp,则A.setExtraLeftOffset(10),并不是30，还有注意单位转换*/
  ...
  /*注：setExtraRight...函数是针对图表绝对位置计算，比如A表offRightA=20dp,B表offRightB=30dp,则A.setExtraLeftOffset(30),并不是10，还有注意单位转换*/
        ...
        bottemcombinedchart.setViewPortOffsets(transLeft, 15, transRight, barBottom);
    }
