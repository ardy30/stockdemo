...
public class Transformer {
     ...
     * @return
     */
    public float[] generateTransformedValuesCandleMin(ICandleDataSet data,
                                                   float phaseX, float phaseY, int from, int to) {
    ...
    public float[] getMaxValues(ICandleDataSet data,
                                float phaseX, float phaseY, int from, int to){
        final int count = (int) Math.ceil((to - from) * phaseX) * 2;
    ...
    public float[] getMinValues(ICandleDataSet data,
                                float phaseX, float phaseY, int from, int to){
        final int count = (int) Math.ceil((to - from) * phaseX) * 2;
