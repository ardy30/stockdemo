...
public class BarChart extends BarLineChartBase<BarData> implements BarDataProvider {
	...
	/**
	 * 柱状图颜色变换数据 0、代表红色，1、代表绿色
	 */
	private ArrayList<Integer> mBarColorValues;
...
//	/**
//	 * 获取柱状图颜色数据0、代表红色，1、代表绿色
//	 * @return
//	 */
//	@Override
//	public ArrayList<Integer> getColorValues() {
//		return mBarColorValues;
//	}
//	/**
//	 * 获取柱状图颜色数据0、代表红色，1、代表绿色
//	 * @return
//	 */
//	public ArrayList<Integer> getBarColorValues() {
//		return mBarColorValues;
//	}
//
//	/**
//	 * 设置柱状图颜色数据0、代表红色，1、代表绿色
//	 * @param barBeanValues
//	 */
//	public void setBarColorValues(ArrayList<Integer> barBeanValues) {
//		mBarColorValues = barBeanValues;
//	}
